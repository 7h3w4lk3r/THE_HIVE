...
* [🔴 Active Directory](network-attacks/active-directory-attacks/README.md)
  ...
  * [⭕ Persistence](network-attacks/active-directory-attacks/kerberos-attacks-1/README.md)
    ...
    * [Kerberosting / AS-REP Rosting](network-attacks/active-directory-attacks/kerberos-attacks-1/kerberosting.md)
...
* [🔴 Defense Evasion](network-attacks/defense-evasion/README.md)
  * [⭕ Basic Tricks](network-attacks/defense-evasion/simple-tricks.md)
  * [⭕ AMSI Bypass](network-attacks/defense-evasion/amsi-bypass.md)
  * [🔧 SRP & AppLocker Bypass](network-attacks/defense-evasion/srp-and-applocker-bypass.md)
  * [🔧 GPO Bypass](network-attacks/defense-evasion/gpo-bypass.md)
* [🔴 Payloads & Shell Escape](network-attacks/payloads-and-shell-escape/README.md)
  * [⭕ Shell Escape / Interactive TTY](network-attacks/payloads-and-shell-escape/interactive-shell.md)
  * [⭕ Magic Unicorn](network-attacks/payloads-and-shell-escape/magic-unicorn.md)
  * [⭕ LOL Binaries](network-attacks/payloads-and-shell-escape/lol-binaries.md)
  * [⭕ msfvenom](network-attacks/payloads-and-shell-escape/msfvenom.md)
  * [⭕ Other Methods](network-attacks/payloads-and-shell-escape/reverse-bind-payloads/README.md)
    * [Web Shells](network-attacks/payloads-and-shell-escape/reverse-bind-payloads/web-shells.md)
    * [Bash](network-attacks/payloads-and-shell-escape/reverse-bind-payloads/bash.md)
    * [Netcat](network-attacks/payloads-and-shell-escape/reverse-bind-payloads/netcat.md)
    * [Ncat](network-attacks/payloads-and-shell-escape/reverse-bind-payloads/ncat.md)
    * [Groovy](network-attacks/payloads-and-shell-escape/reverse-bind-payloads/groovy.md)
    * [Ghawk](network-attacks/payloads-and-shell-escape/reverse-bind-payloads/gawk.md)
    * [Powercat](network-attacks/payloads-and-shell-escape/reverse-bind-payloads/powercat.md)
    * [C](network-attacks/payloads-and-shell-escape/reverse-bind-payloads/c.md)
    * [Xterm](network-attacks/payloads-and-shell-escape/reverse-bind-payloads/xterm.md)
    * [Telnet](network-attacks/payloads-and-shell-escape/reverse-bind-payloads/telnet.md)
    * [Socat](network-attacks/payloads-and-shell-escape/reverse-bind-payloads/socat.md)
    * [Ruby](network-attacks/payloads-and-shell-escape/reverse-bind-payloads/ruby.md)
    * [LUA](network-attacks/payloads-and-shell-escape/reverse-bind-payloads/lua.md)
    * [PHP](network-attacks/payloads-and-shell-escape/reverse-bind-payloads/php.md)
    * [Java](network-attacks/payloads-and-shell-escape/reverse-bind-payloads/java.md)
    * [Powershell](network-attacks/payloads-and-shell-escape/reverse-bind-payloads/powershell.md)
    * [Perl](network-attacks/payloads-and-shell-escape/reverse-bind-payloads/perl.md)
    * [Python](network-attacks/payloads-and-shell-escape/reverse-bind-payloads/python.md)
* [🔧 Command & Control](network-attacks/command-and-control/README.md)
  * [⭕ Metasploit](network-attacks/command-and-control/metasploit.md)
...
* [🔴 Firewall / IDS Evasion](network-devices/firewall-ids-evasion.md)
* [🔧 Printer Exploitation](network-devices/printer-exploitation.md)
* [🔴 IPv6 Attacks](network-devices/ipv6-attacks/README.md)
  * [⭕ Neighbor Impersonation](network-devices/ipv6-attacks/neighbor-impersonation.md)
  * [⭕ Router Advertisement Flooding](network-devices/ipv6-attacks/router-advertisement-flooding.md)
* [🔴 Switch Attacks](network-devices/switch-attacks/README.md)
  * [⭕ Cisco Exploitation](network-devices/switch-attacks/cisco-exploitation.md)
  * [⭕ STP Spoofing](network-devices/switch-attacks/stp-spoofing.md)
  * [⭕ VLAN Hopping](network-devices/switch-attacks/vlan-hopping.md)
  * [⭕ MAC Flood](network-devices/switch-attacks/mac-flood.md)
* [🔴 Router Attacks](network-devices/router-attacks/README.md)
  * [⭕ Router Exploitation](network-devices/router-attacks/router-exploitation.md)
  * [⭕ HSRP Hijacking](network-devices/router-attacks/hsrp-hijacking.md)
  * [🔧 RIP Spoofing](network-devices/router-attacks/rip-spoofing.md)
  * [🔧 OSPF Attacks](network-devices/router-attacks/ospf-attacks.md)
  * [🔧 VRRP MitM](network-devices/router-attacks/vrrp-mitm.md)
* [🔴 NAC Bypass](network-devices/nac/README.md)
  * [⭕ Captive Portal](network-devices/nac/captive-portal.md)
  * [⭕ 802.1X / EAP Bypass](network-devices/nac/802.1x-eap-bypass.md)
...
* [C Programming](codding/c/README.md)
  * [Basic Structure](codding/c/basic-structure.md)
  * [GCC Compiler](codding/c/gcc-compiler.md)
  * [Preprocessors](codding/c/preprocessors.md)
  * [Data Types](codding/c/data-types.md)
  * [Type Qualifiers](codding/c/type-qualifiers.md)
  * [Pointers](codding/c/pointers.md)
  * [Dynamic Memory Allocation](codding/c/dynamic-memory-allocation.md)
  * [Loops](codding/c/loops.md)
  * [Conditional Statements](codding/c/conditional-statements.md)
  * [Functions](codding/c/functions.md)
  * [Input / Output](codding/c/input-output.md)
  * [Macros](codding/c/macros.md)
  * [Files](codding/c/files.md)
  * [Strings Manipulation](codding/c/strings-manipulation.md)
  * [Bit Manipulation](codding/c/bit-manipulation.md)
  * [Data Structures](codding/c/data-structures/README.md)
    * [Arrays](codding/c/data-structures/arrays.md)
    * [Structures](codding/c/data-structures/structures.md)
    * [Unions](codding/c/data-structures/unions.md)
  * [Abstract Data Types](codding/c/abstract-data-types/README.md)
    * [Stack](codding/c/abstract-data-types/stack.md)
    * [Queue](codding/c/abstract-data-types/queue.md)
    * [Linked List](codding/c/abstract-data-types/linked-lists/README.md)
      * [Singly Linked List](codding/c/abstract-data-types/linked-lists/singly-linked-list.md)
      * [Doubly Linked List](codding/c/abstract-data-types/linked-lists/doubly-linked-list.md)
  * [Libraries & Linking](codding/c/libraries-and-linking.md)
  * [Error Recovery](codding/c/error-recovery.md)
* [🔧 Assembly ( NASM )](codding/assembly/README.md)
  * [Intel IA-32 Environment](codding/assembly/basics.md)
  * [Basic Structure](codding/assembly/basic-structure.md)
  * [Variables and Data Types](codding/assembly/variables-and-data-types.md)
  * [Most-used Instructions](codding/assembly/most-used-instructions.md)
  * [input / output](codding/assembly/input-output.md)
