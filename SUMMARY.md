...
* [🔴 Windows](network-attacks/windows/README.md)
  * [⭕ Security Concepts](network-attacks/windows/concepts/README.md)
    * [Windows Security Components](network-attacks/windows/concepts/security-component.md)
    * [Active Directory Components](network-attacks/windows/concepts/active-directory-components.md)
    * [Kerberos](network-attacks/windows/concepts/kerberos.md)
    * [Loggon Sessions and Access Tokens](network-attacks/windows/concepts/loggon-sessions-and-access-tokens.md)
    * [Permissions and Access Control](network-attacks/windows/concepts/permissions.md)
    * [Windows Registry](network-attacks/windows/concepts/windows-registry.md)
    * [Object Management](network-attacks/windows/concepts/object-management.md)
* [Windows & AD](network-attacks/active-directory-attacks/README.md)
  ...
  * [🔧 Local Persistence](network-attacks/active-directory-attacks/persistence.md)
  * [🔧 Domain Persistence](network-attacks/active-directory-attacks/kerberos-attacks-1/README.md)
...
* [Printer Exploitation](layer-2-and-3-attacks/printer-exploitation.md)
* [🔴 Firewall / IDS Evasion](layer-2-and-3-attacks/firewall-ids-evasion.md)
