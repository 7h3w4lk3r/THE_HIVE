...
{% embed url="https://github.com/theodorecooper/awesome-ddos-tools/blob/main/list.md" %}

{% embed url="https://github.com/palahsu/DDoS-Ripper" %}

{% embed url="https://github.com/Leeon123/CC-attack" %}

{% embed url="https://github.com/Tmpertor/Raven-Storm" %}

{% embed url="https://cybervm.io/" %}

## <mark style="color:red;">Metasploit DoS Modules</mark>
...
auxiliary/dos/windows/ftp/filezilla_admin_r
...
auxiliary/dos/windows/ftp/solarftp_r
...
{% embed url="https://www.hackingarticles.in/dos-penetration-testing-part-1/" %}

{% embed url="https://www.hackingarticles.in/dos-attack-penetration-testing-part-2/" %}
