...
namespace TestClass
{
    class TestClass
    {
        ...
        static void Main(string[] args)
        {
            ...
            // replace with encrypted shellcode
...
{% hint style="danger" %}
#### Targeting well-known windows native processes like `svchost` and `explorer` might trigger EDRs and windows defender.
{% endhint %}
