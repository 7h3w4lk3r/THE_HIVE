...
#### <mark style="color:green;">In simple words, COM is a system that helps developers build libraries which can co-operate with other apps developed with other languages.</mark>
...
{% hint style="info" %}
#### COM usually lives in a DLL, sometimes as a EXE.  It can also live on a remote machine.
{% endhint %}
...
#### <mark style="color:green;">One way to hijack the COM is by modifying the registry key in</mark> <mark style="color:green;"></mark><mark style="color:green;">`HKEY_CUTRRENT_USER`</mark>`.`
